...
#define STRING_CONFIG_H_AUTHOR "dleertouwer" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Creality Ender 3 Pro"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.20, 79.20, 400, 100 }
...
/**
 * The BLTouch probe is connected to a pin 27 adapter board (and Z-min pin).
 */
